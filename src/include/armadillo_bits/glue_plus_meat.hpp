...
inline
void
glue_plus::apply(basic_mat<eT>& out, const basic_mat<eT>& A, const basic_mat<eT>& B)
  {
...
inline
void
glue_plus::apply(basic_mat<eT>& out, const basic_mat<eT>& A, const basic_mat<eT>& B, const basic_mat<eT>& C)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_plus::apply(basic_mat<eT>& out, const glue_data<basic_mat<eT>,basic_mat<eT>,glue_plus>& X)
  {
...
inline
void
glue_plus::apply(basic_mat<eT>& out, const glue_data< glue_data<basic_mat<eT>,basic_mat<eT>,glue_plus>, basic_mat<eT>, glue_plus>& X)
  {
...
inline
void
glue_plus::apply(basic_mat<typename T1::elem_type>& out, const glue_data<T1,T2,glue_plus>& X)
  {
  arma_extra_debug_sigprint();
  
  typedef typename T1::elem_type eT;
  
  const u32 N_mat = 1 + depth_lhs< glue_plus, glue_data<T1,T2,glue_plus> >::num;
  ...
  if(N_mat == 2)
    ...
    mat_ptrs<glue_plus, glue_data<T1,T2,glue_plus> >::get_ptrs(ptrs, del, X);
...
inline
void
glue_plus::apply(basic_mat<eT>& out, const glue_data<basic_mat<eT>, subview<eT>, glue_plus>& X)
  {
  arma_extra_debug_sigprint();
  
  const basic_mat<eT>& orig_A = X.A;
  const basic_mat<eT>& orig_B = X.B.m;
  ...
  if( &out != &orig_B )
    ...
    {
    const basic_mat<eT> processed_B(X.B);  // create a matrix out of subview
...
inline
void
glue_plus::apply(basic_mat<eT>& out, const glue_data< subview<eT>, basic_mat<eT>, glue_plus>& X)
  {
  arma_extra_debug_sigprint();
  
  const basic_mat<eT>& orig_A = X.A.m;
  
  const unwrap_check< basic_mat<eT> > tmp(X.B, out);
  const basic_mat<eT>& orig_B = tmp.M;
  ...
  if( &out != &orig_A )
    ...
    {
    const basic_mat<eT> processed_A(X.A);
...
inline
void
glue_plus::apply(basic_mat<eT>& out, const glue_data< subview<eT>, subview<eT>, glue_plus>& X)
  {
  arma_extra_debug_sigprint();
  ...
  if( (&out != &orig_A) && (&out != &orig_B) )
    ...
    {
    const basic_mat<eT> processed_A(X.A);
    const basic_mat<eT> processed_B(X.B);
...
template<typename eT>
inline void glue_plus::apply_inplace(basic_mat<eT>& out, const basic_mat<eT>& B)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_plus::apply_inplace(basic_mat<typename T1::elem_type>& out, const op_data<T1, op_type>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_plus::apply_inplace(basic_mat<typename T1::elem_type>& out, const op_data<T1, op_square>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_plus::apply_inplace(basic_mat<typename T1::elem_type>& out, const glue_data<T1, T2, glue_type>& X)
  {
  arma_extra_debug_sigprint();
...
glue_plus::apply
  (
  basic_mat<typename T1::elem_type>& out,
  const glue_data< glue_data<T1,T2,glue_times>, T3, glue_plus>& in
  )
  {
  arma_extra_debug_sigprint();
  
  const unwrap<T1> tmp1(in.A.A);
  const unwrap<T2> tmp2(in.A.B);
  const unwrap<T3> tmp3(in.B);
  
  typedef typename T1::elem_type eT;
  
  const basic_mat<eT>& A = tmp1.M;
  const basic_mat<eT>& B = tmp2.M;
  const basic_mat<eT>& C = tmp3.M;
  ...
  if( (&out != &A) && (&out != &B) )
    ...
    {
    const unwrap_check< basic_mat<eT> > tmp1(A,out);
    const unwrap_check< basic_mat<eT> > tmp2(B,out);
    
    const basic_mat<eT>& A_safe = tmp1.M;
    const basic_mat<eT>& B_safe = tmp2.M;
    
    out = C;
    gemm<false,false,false,true>::apply(out, A_safe, B_safe, eT(1), eT(1));
...
glue_plus::apply
  (
  basic_mat<typename T1::elem_type>& out,
  const glue_data< T1, glue_data<T2,T3,glue_times>, glue_plus>& in
  )
  {
  arma_extra_debug_sigprint();
  
  const unwrap<T1> tmp1(in.A);
  const unwrap<T2> tmp2(in.B.A);
  const unwrap<T3> tmp3(in.B.B);
  ...
  arma_debug_assert_same_size(A.n_rows, A.n_cols, B.n_rows, C.n_cols, "matrix addition");
  
  
  if( (&out != &B) && (&out != &C) )
    {
    out = A;
    gemm<false,false,false,true>::apply(out, B, C, eT(1), eT(1));
    }
  else
    {
    const unwrap_check< basic_mat<eT> > tmp1(B,out);
    const unwrap_check< basic_mat<eT> > tmp2(C,out);
    
    const basic_mat<eT>& B_safe = tmp1.M;
    const basic_mat<eT>& C_safe = tmp2.M;
    
    out = A;
    gemm<false,false,false,true>::apply(out, B_safe, C_safe, eT(1), eT(1));
    }
...
glue_plus::apply
  (
  basic_mat<typename T1::elem_type>& out,
  const glue_data< glue_data< T1, basic_colvec<typename T1::elem_type>, glue_times_vec>, T2, glue_plus>& in
  )
  {
  arma_extra_debug_sigprint();
  ...
  const basic_mat<eT>&    A = tmp1.M;
  const basic_colvec<eT>& B = in.A.B;
  const basic_mat<eT>&    C = tmp2.M;
  ...
  if( (&out != &A) && (&out != &B) )
    ...
    {
    const unwrap_check< basic_mat<eT>    > tmp1(A,out);
    const unwrap_check< basic_colvec<eT> > tmp2(B,out);
    
    const basic_mat<eT>&    A_safe = tmp1.M;
    const basic_colvec<eT>& B_safe = tmp2.M;
...
glue_plus::apply
  (
  basic_mat<typename T1::elem_type>& out,
  const glue_data< glue_data< basic_rowvec<typename T1::elem_type>, T1, glue_times_vec>, T2, glue_plus>& in
  )
  {
  arma_extra_debug_sigprint();
  ...
  const basic_rowvec<eT>& A = in.A.A;
  const basic_mat<eT>&    B = tmp1.M;
  const basic_mat<eT>&    C = tmp2.M;
...
inline
void
glue_plus::apply_mixed(basic_mat<typename promote_type<eT1,eT2>::result>& out, const basic_mat<eT1>& X, const basic_mat<eT2>& Y)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_plus_diag::apply(basic_mat<typename T1::elem_type>& out, const T1& A_orig, const op_data<T2,op_diagmat>& B_orig)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_plus_diag::apply(basic_mat<typename T1::elem_type>& out, const op_data<T1,op_diagmat>& A_orig, const op_data<T2,op_diagmat>& B_orig)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_plus_diag::apply(basic_mat<typename T1::elem_type>& out, const glue_data<T1, op_data<T2,op_diagmat>, glue_plus_diag>& X)
  {
...
inline
void
glue_plus_diag::apply(basic_mat<typename T1::elem_type>& out, const glue_data<op_data<T1,op_diagmat>, T2, glue_plus_diag>& X)
  {
...
inline
void
glue_plus_diag::apply(basic_mat<typename T1::elem_type>& out, const glue_data<op_data<T1,op_diagmat>, op_data<T2,op_diagmat>, glue_plus_diag>& X)
  {
  glue_plus_diag::apply(out, X.A, X.B);
  }
