...
inline
u32 glue_times::mul_storage_cost(const basic_mat<eT>& X, const basic_mat<eT>& Y)
  {
...
inline
void
glue_times::apply_noalias(basic_mat<eT>& out, const basic_mat<eT>& A, const basic_mat<eT>& B)
  {
...
inline
void
glue_times::apply(basic_mat<eT>& out, const basic_mat<eT>& A_in, const basic_mat<eT>& B_in)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times::apply(basic_mat<eT>& out, const basic_mat<eT>& A, const basic_mat<eT>& B, const basic_mat<eT>& C)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times::apply(basic_mat<eT>& out, const glue_data<basic_mat<eT>,basic_mat<eT>,glue_times>& X)
  {
...
inline
void
glue_times::apply(basic_mat<eT>& out, const glue_data< glue_data<basic_mat<eT>,basic_mat<eT>, glue_times>, basic_mat<eT>, glue_times>& X)
  {
...
void
glue_times::apply(basic_mat<typename T1::elem_type>& out, const glue_data<T1,T2,glue_times>& X)
  {
  arma_extra_debug_sigprint();

  typedef typename T1::elem_type eT;

  const s32 N_mat = 1 + depth_lhs< glue_times, glue_data<T1,T2,glue_times> >::num;
  ...
  if(N_mat == 2)
    ...
    mat_ptrs_outcheck<glue_times, glue_data<T1,T2,glue_times> >::get_ptrs(ptrs, del, X, &out);
    ...
    const basic_mat<eT>* src_mat_1_ptr = ptrs[current_id];
    const basic_mat<eT>* src_mat_2_ptr = 0;
  
    // TODO:
    // allocate two storage areas (of size 'largest_size'), not two matrices
  
    
    basic_mat<eT> tmp_mat_1;
    basic_mat<eT> tmp_mat_2;
    
    basic_mat<eT>* tmp_mat_1_ptr = &tmp_mat_1;
    basic_mat<eT>* tmp_mat_2_ptr = (N_mul <= 2) ? 0 : &tmp_mat_2;
  
    basic_mat<eT>* dest_mat_ptr  = tmp_mat_2_ptr;
...
inline
void
glue_times::apply_inplace(basic_mat<eT>& out, const basic_mat<eT>& B)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times::apply_inplace(basic_mat<typename T1::elem_type>& out, const op_data<T1, op_type>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times::apply_inplace(basic_mat<typename T1::elem_type>& out, const glue_data<T1, T2, glue_type>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times::apply(basic_mat<typename T1::elem_type>& out, const glue_data<T1, op_data<T2,op_trans>, glue_times>& X)
  {
  arma_extra_debug_sigprint();
  ...
  if( (A.n_rows*B.n_rows) > 0)
    ...
    if(&A != &B)   // A*B'
      {
      unwrap_check< basic_mat<eT> > A_safe_tmp(A, out);
      unwrap_check< basic_mat<eT> > B_safe_tmp(B, out);
      
      const basic_mat<eT>& A_safe = A_safe_tmp.M;
      const basic_mat<eT>& B_safe = B_safe_tmp.M;
...
inline
void
glue_times::apply(basic_mat<typename T1::elem_type>& out, const glue_data< op_data<T1,op_trans>, T2, glue_times>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times::apply(basic_mat<typename T1::elem_type>& out, const glue_data< op_data<T1,op_trans>, op_data<T2,op_trans>, glue_times>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times::apply(basic_mat<typename T1::elem_type>& out, const glue_data< op_data<T1, op_neg>, T2, glue_times>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times::apply_mixed(basic_mat<typename promote_type<eT1,eT2>::result>& out, const basic_mat<eT1>& X, const basic_mat<eT2>& Y)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times_diag::apply(basic_mat<typename T1::elem_type>& out, const T1& A_orig, const op_data<T2,op_diagmat>& B_orig)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times_diag::apply(basic_mat<typename T1::elem_type>& out, const op_data<T1,op_diagmat>& A_orig, const T2& B_orig)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_times_diag::apply(basic_mat<typename T1::elem_type>& out, const op_data<T1,op_diagmat>& A_orig, const op_data<T2,op_diagmat>& B_orig)
  {
  arma_extra_debug_sigprint();
...
inline
void 
glue_times_diag::apply(basic_mat<typename T1::elem_type>& out, const glue_data<T1, op_data<T2,op_diagmat>, glue_times_diag>& X)
  {
...
inline
void
glue_times_diag::apply(basic_mat<typename T1::elem_type>& out, const glue_data<op_data<T1,op_diagmat>, T2, glue_times_diag>& X)
  {
  glue_times_diag::apply(out, X.A, X.B);
  }
...
inline
void
glue_times_diag::apply(basic_mat<typename T1::elem_type>& out, const glue_data<op_data<T1,op_diagmat>, op_data<T2,op_diagmat>, glue_times_diag>& X)
  {
  glue_times_diag::apply(out, X.A, X.B);
  }
...
inline
void
glue_times_vec::mul_col_row(basic_mat<eT>& out, const eT* A, const eT* B)
  {
...
inline
void
glue_times_vec::apply(basic_mat<typename T1::elem_type>& out, const glue_data<T1, basic_colvec<typename T1::elem_type>,glue_times_vec>& X)
  {
  arma_extra_debug_sigprint();
  ...
  unwrap_check< basic_colvec<eT> > tmp2(X.B, out);
  
  const basic_mat<eT>&    A = tmp1.M;
  const basic_colvec<eT>& B = tmp2.M;

  arma_debug_assert_mul_size(A, B, "vector multiply");
  
  out.set_size(A.n_rows, 1);
  
  //gemm<>::apply(out,A,B);  // NOTE: B is interpreted as a basic_mat
...
inline
void
glue_times_vec::apply(basic_mat<typename T1::elem_type>& out, const glue_data<T1, basic_rowvec<typename T1::elem_type>,glue_times_vec>& X)
  {
  arma_extra_debug_sigprint();
  ...
  unwrap_check< T1 >               tmp1(X.A, out);
  unwrap_check< basic_rowvec<eT> > tmp2(X.B, out);
  
  const basic_mat<eT>& A = tmp1.M;
  const basic_mat<eT>& B = tmp2.M;   // NOTE: interpretation of a basic_rowvec as a basic_mat
...
inline
void
glue_times_vec::apply(basic_mat<typename T1::elem_type>& out, const glue_data<basic_colvec<typename T1::elem_type>,T1,glue_times_vec>& X)
  {
  arma_extra_debug_sigprint();
  ...
  unwrap_check< basic_colvec<eT> > tmp1(X.A, out);
  unwrap_check< T1 >               tmp2(X.B, out);
  
  const basic_mat<eT>& A = tmp1.M;   // NOTE: interpretation of a basic_colvec as a basic_mat
  const basic_mat<eT>& B = tmp2.M;
...
inline
void
glue_times_vec::apply(basic_mat<typename T1::elem_type>& out, const glue_data<basic_rowvec<typename T1::elem_type>,T1,glue_times_vec>& X)
  {
  arma_extra_debug_sigprint();
  
  typedef typename T1::elem_type eT;
  
  unwrap_check< basic_rowvec<eT> > tmp1(X.A, out);
  unwrap_check< T1 >               tmp2(X.B, out);
  
  const basic_rowvec<eT>& A = tmp1.M;
  const basic_mat<eT>&    B = tmp2.M;
...
inline
void
glue_times_vec::apply(basic_mat<eT>& out, const glue_data<basic_colvec<eT>,basic_rowvec<eT>,glue_times_vec>& X)
  {
  arma_extra_debug_sigprint();
  ...
  const basic_colvec<eT>& A = tmp1.M;
  const basic_rowvec<eT>& B = tmp2.M;
...
inline
void
glue_times_vec::apply(basic_mat<eT>& out, const glue_data< op_data<basic_rowvec<eT>, op_trans>, basic_rowvec<eT>, glue_times_vec>& X)
  {
  arma_extra_debug_sigprint();
  
  unwrap_check< basic_rowvec<eT> > tmp1(X.A.m, out);
  unwrap_check< basic_rowvec<eT> > tmp2(X.B,   out);
...
inline
void
glue_times_vec::apply(basic_mat<eT>& out, const glue_data< basic_colvec<eT>, op_data<basic_colvec<eT>, op_trans>, glue_times_vec>& X)
  {
  arma_extra_debug_sigprint();
  
  unwrap_check< basic_colvec<eT> > tmp1(X.A,   out);
  unwrap_check< basic_colvec<eT> > tmp2(X.B.m, out);
...
inline
void
glue_times_vec::apply(basic_mat<typename T1::elem_type>& out, const glue_data<op_data<T1, op_trans>, basic_colvec<typename T1::elem_type>,glue_times_vec>& X)
  {
  arma_extra_debug_sigprint();
