...
inline
void
op_diagmat::zero_offdiag(basic_mat<eT>& X)
  {
...
inline
void
op_diagmat::apply(basic_mat<typename T1::elem_type>& out, const op_data<T1,op_diagmat>& in)
  {
...
inline
void
op_diagmat::apply(basic_mat<typename T1::elem_type>& out, const op_data< glue_data<T1,T2, glue_div>, op_diagmat>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_diagmat::apply(basic_mat<typename T1::elem_type>& out, const op_data< glue_data<T1,T2, glue_minus>, op_diagmat>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_diagmat::apply(basic_mat<typename T1::elem_type>& out, const op_data< glue_data<T1,T2, glue_plus>, op_diagmat>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_diagmat::apply(basic_mat<typename T1::elem_type>& out, const op_data< glue_data<T1,T2, glue_schur>, op_diagmat>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_diagmat::apply(basic_mat<typename T1::elem_type>& out, const op_data< glue_data<T1,T2, glue_times>, op_diagmat>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_diagmat_vec::apply(basic_mat<typename T1::elem_type>& out, const op_data<T1, op_diagmat_vec>& in)
  {
  arma_extra_debug_sigprint();
