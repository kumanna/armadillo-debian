...
accu(const arma_base<typename T1::elem_type,T1>& X)
  {
...
inline
typename T1::elem_type
accu(const op_data<T1, op_diagmat>& X)
  {
  arma_extra_debug_sigprint();
...
inline
eT
accu(const op_data<basic_mat<eT>, op_diagmat_vec>& X)
  {
  arma_extra_debug_sigprint();
  
  const basic_mat<eT>& A = X.m;
...
inline
typename T1::elem_type
accu(const op_data<T1, op_square>& in)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
accu(const op_data<T1, op_sqrt>& in)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
accu(const op_data< glue_data<T1,T2, glue_minus>, op_square>& in)
  {
  arma_extra_debug_sigprint();
...
inline
eT
accu_schur(const basic_mat<eT>& A, const basic_mat<eT>& B)
  {
  arma_extra_debug_sigprint();
...
inline
eT
accu(const glue_data<basic_mat<eT>,basic_mat<eT>,glue_schur>& X)
  {
...
inline
eT
accu(const glue_data<glue_data<basic_mat<eT>,basic_mat<eT>,glue_schur>,basic_mat<eT>,glue_schur>& X)
  {
  arma_extra_debug_sigprint();
  
  const basic_mat<eT>& A = X.A.A;
  const basic_mat<eT>& B = X.A.B;
  const basic_mat<eT>& C = X.B;
...
//! while T1 and T2 can be 'mat', 'rowvec', 'colvec', 'op_data', 'glue_data'
    
template<typename T1, typename T2>
inline
typename T1::elem_type
accu(const glue_data<T1,T2,glue_schur>& X)
  {
  arma_extra_debug_sigprint();
  ...
  if(N_mat == 2)
    {
    return accu_schur(basic_mat<eT>(X.A), basic_mat<eT>(X.B));
    }
  else
    {
...
inline
eT
accu(const glue_data<subview<eT>,basic_mat<eT>,glue_schur>& X)
  {
  arma_extra_debug_sigprint();
  
  arma_debug_assert_same_size(X.A, X.B, "accu()");
  
  const basic_mat<eT>& A = X.A.m;
...
inline
eT
accu(const glue_data<basic_mat<eT>,subview<eT>,glue_schur>& X)
  {
  arma_extra_debug_sigprint();
  
  arma_debug_assert_same_size(X.A, X.B, "accu()");
  
  const basic_mat<eT>& A = X.A;
...
inline
eT
accu(const glue_data<subview<eT>,subview<eT>,glue_schur>& X)
  {
  arma_extra_debug_sigprint();
