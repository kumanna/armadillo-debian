...
inline
void
arma_assert_same_size(const basic_mat<eT1>& A, const basic_mat<eT2>& B, const char* x)
  {
...
inline
void
arma_assert_same_size(const basic_mat<eT1>& A, const subview<eT2>& B, const char* x)
  {
  if( (A.n_rows != B.n_rows) || (A.n_cols != B.n_cols) )
    {
    throw std::runtime_error
...
inline
void
arma_assert_same_size(const subview<eT1>& A, const basic_mat<eT2>& B, const char* x)
  {
  if( (A.n_rows != B.n_rows) || (A.n_cols != B.n_cols) )
    {
    throw std::runtime_error
...
inline
void
arma_assert_mul_size(const basic_mat<eT1>& A, const basic_mat<eT2>& B, const char* x)
  {
...
inline
void
arma_assert_mul_size(const basic_mat<eT1>& A, const subview<eT2>& B, const char* x)
  {
  if(A.n_cols != B.n_rows)
    {
    throw std::runtime_error
...
inline
void
arma_assert_mul_size(const subview<eT1>& A, const basic_mat<eT2>& B, const char* x)
  {
  if(A.n_cols != B.n_rows)
    {
    throw std::runtime_error
  ...
  namespace junk
    ...
    class arma_first_extra_debug_message
      ...
      arma_first_extra_debug_message()
        {
        std::cout << "@ ---" << std::endl;
        std::cout << "@ Armadillo " << arma_version::major << '.' << arma_version::minor << '.' << arma_version::patch << std::endl;
        std::cout << "@ arma_config::atlas  = " << arma_config::atlas << std::endl;
        std::cout << "@ arma_config::lapack = " << arma_config::lapack << std::endl;
        std::cout << "@ arma_config::blas   = " << arma_config::blas << std::endl;
        std::cout << "@ arma_config::boost  = " << arma_config::boost << std::endl;
