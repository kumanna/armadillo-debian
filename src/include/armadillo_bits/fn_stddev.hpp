...
stddev(const arma_base<typename T1::elem_type,T1>& X, const u32 norm_type = 0, const u32 dim = 0)
  {
...
inline
eT
stddev(const basic_rowvec<eT>& A, const u32 norm_type = 0)
  {
  arma_extra_debug_sigprint();
...
inline
T
stddev(const basic_rowvec< std::complex<T> >& A, const u32 norm_type = 0)
  {
  arma_extra_debug_sigprint();
...
inline
eT
stddev(const basic_colvec<eT>& A, const u32 norm_type = 0)
  {
  arma_extra_debug_sigprint();
...
inline
T
stddev(const basic_colvec< std::complex<T> >& A, const u32 norm_type = 0)
  {
  arma_extra_debug_sigprint();
