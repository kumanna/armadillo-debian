...
umat
operator==
(const arma_base<eT,T1>& X, const arma_base<eT,T2>& Y)
  {
...
umat
operator==
(const arma_base<typename T1::elem_type,T1>& X, const typename T1::elem_type val)
  {
  arma_extra_debug_sigprint();
...
umat
operator==
(const typename T1::elem_type val, const arma_base<typename T1::elem_type,T1>& X)
  {
