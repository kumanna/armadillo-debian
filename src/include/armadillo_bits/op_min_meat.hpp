...
inline void op_min::apply(basic_mat<typename T1::elem_type>& out, const op_data<T1,op_min>& in)
  {
  arma_extra_debug_sigprint();
...
inline void op_min::apply(basic_mat< std::complex<T> >& out, const op_data<T1,op_min>& in)
  {
  arma_extra_debug_sigprint();
