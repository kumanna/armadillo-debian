...
template<typename T1> inline typename T1::elem_type det(const arma_base<typename T1::elem_type,T1>& X);
template<typename T1> inline typename T1::elem_type det(const op_data<T1, op_diagmat>& X);

template<typename eT> inline eT det(const op_data<basic_mat<eT>, op_diagmat_vec>& X);

template<typename T1, typename T2> inline typename T1::elem_type det(const glue_data<T1, T2, glue_times>& X);

template<typename T1> inline typename T1::elem_type det(const op_data<T1,op_inv>& in);
template<typename T1> inline typename T1::elem_type det(const op_data<T1,op_trans>& in);
...
det(const arma_base<typename T1::elem_type,T1>& X)
  {
...
inline
typename T1::elem_type
det(const op_data<T1, op_diagmat>& X)
  {
  arma_extra_debug_sigprint();
...
inline
eT
det(const op_data<basic_mat<eT>, op_diagmat_vec>& X)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
det(const glue_data<T1,T2,glue_times>& X)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
det(const op_data<T1,op_inv>& in)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
det(const op_data<T1,op_trans>& in)
  {
  arma_extra_debug_sigprint();
