...
inline
void
op_inv::apply(basic_mat<eT>& out, const basic_mat<eT>& A)
  {
...
inline
void
op_inv::apply(basic_mat<typename T1::elem_type>& out, const op_data<T1,op_inv>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_inv::apply(basic_mat<typename T1::elem_type>& out, const op_data< op_data<T1,op_diagmat>, op_inv>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_inv::apply_diagvec(basic_mat<eT>& out, const basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_inv::apply(basic_mat<eT>& out, const op_data< op_data<basic_mat<eT>,op_diagmat_vec>, op_inv>& in)
  {
  arma_extra_debug_sigprint();
  
  const basic_mat<eT>& X = in.m.m;
