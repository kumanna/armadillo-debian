...
template<typename T>
struct is_basic_mat_only
  { static const bool value = false; };  

template<>
template<typename eT>
struct is_basic_mat_only< basic_mat<eT> >
...
template<>
template<typename eT>
struct is_basic_mat< basic_mat<eT> >
  { static const bool value = true; };

template<>
template<typename eT>
struct is_basic_mat< basic_rowvec<eT> >
  { static const bool value = true; };

template<>
template<typename eT>
struct is_basic_mat< basic_colvec<eT> >
  { static const bool value = true; };



template<typename T>
struct is_basic_rowvec
  { static const bool value = false; };

template<>
template<typename eT>
struct is_basic_rowvec< basic_rowvec<eT> >
  { static const bool value = true; };



template<typename T>
struct is_basic_colvec
  { static const bool value = false; };

template<>
template<typename eT>
struct is_basic_colvec< basic_colvec<eT> >
  { static const bool value = true; };
...
struct is_op_data< op_data<T1,op_type> >
  { static const bool value = true; };
...
struct is_glue_data< glue_data<T1,T2,glue_type> >
  { static const bool value = true; };
...
struct is_arma_type
  ...
  =  is_basic_mat<T1>::value
  || is_op_data<T1>::value
  || is_glue_data<T1>::value
  || is_subview<T1>::value
...
struct upgrade_val<T,T>
  ...
  inline static const T& apply(const T& x) { return x; }
  };
...
struct upgrade_val< std::complex<T>, T2 >
  ...
  inline static const std::complex<T>& apply(const std::complex<T>& x) { return x;    }
  inline static const T                apply(const T2 x)               { return T(x); }
  };
...
struct upgrade_val< T1, std::complex<T> >
  ...
  inline static const T                apply(const T1 x)               { return T(x); }
  inline static const std::complex<T>& apply(const std::complex<T>& x) { return x;    }
  };
...
struct upgrade_val< std::complex<float>, double >
  ...
  inline static const std::complex<double> apply(const std::complex<float>& x) { return std::complex<double>(x); }
  inline static const double               apply(const double x)               { return x; }
  };
...
//! ensure we don't lose precision when multiplying a complex numbers with different underlying types
template<>
struct upgrade_val< std::complex<float>, std::complex<double> >
  ...
  inline static const std::complex<double>  apply(const std::complex<float>&  x) { return std::complex<double>(x); }
  inline static const std::complex<double>& apply(const std::complex<double>& x) { return x; }
  };
...
struct upgrade_val< std::complex<double>, float >
  ...
  inline static const std::complex<double>& apply(const std::complex<double>& x) { return x; }
  inline static const double                apply(const float x)                 { return double(x); }
  };
