...
inline
void
op_trans::apply_noalias(basic_mat<eT>& out, const basic_mat<eT>& A)
  {
...
inline
void
op_trans::apply(basic_mat<eT>& out, const basic_mat<eT>& A)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_trans::apply(basic_mat<typename T1::elem_type>& out, const op_data<T1,op_trans>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_trans::apply(basic_mat<typename T1::elem_type>& out, const op_data< glue_data<T1,T2,glue_plus>, op_trans>& in)
  {
  arma_extra_debug_sigprint();
