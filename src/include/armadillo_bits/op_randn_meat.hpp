...
inline
void
op_randn::apply(basic_mat<eT>& out, const op_data<basic_mat<eT>,op_randn>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_randn::apply(basic_mat<eT>& out, const op_data<basic_colvec<eT>,op_randn>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_randn::apply(basic_mat<eT>& out, const op_data<basic_rowvec<eT>,op_randn>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_randn::apply(basic_colvec<eT>& out, const op_data<basic_colvec<eT>,op_randn>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_randn::apply(basic_rowvec<eT>& out, const op_data<basic_rowvec<eT>,op_randn>& in)
  {
  arma_extra_debug_sigprint();
