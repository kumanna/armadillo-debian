...
inline
void
op_htrans::apply_noalias(basic_mat< std::complex<T> >& out, const basic_mat< std::complex<T> >& A)
  {
...
inline
void
op_htrans::apply(basic_mat< std::complex<T> >& out, const basic_mat< std::complex<T> >& A)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_htrans::apply(basic_mat< std::complex<T> >& out, const op_data<T1,op_htrans>& in)
  {
  arma_extra_debug_sigprint();
