...
inline
void
auxlib::inv_noalias(basic_mat<eT>& out, const basic_mat<eT>& X)
  {
...
inline
void
auxlib::inv_inplace(basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
inline
eT
auxlib::det(const basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
auxlib::lu(basic_mat<eT>& L, basic_mat<eT>& U, podarray<int>& ipiv, const basic_mat<eT>& X_orig)
  {
  arma_extra_debug_sigprint();
  
  arma_debug_check( (&L == &U), "auxlib::lu(): L and U are the same object");
  
  unwrap_check< basic_mat<eT> > tmp1(X_orig, U);
  const basic_mat<eT>& X_tmp = tmp1.M;
  
  unwrap_check< basic_mat<eT> > tmp2(X_tmp, L);
  const basic_mat<eT>& X = tmp2.M;
  ...
  U = X;
  ...
  #if defined(ARMA_USE_ATLAS) || defined(ARMA_USE_LAPACK)
    {
      ...
      int info = atlas::clapack_getrf(atlas::CblasColMajor, U.n_rows, U.n_cols, U.memptr(), U.n_rows, ipiv.memptr());
      }
    #elif defined(ARMA_USE_LAPACK)
      {
      ipiv.set_size(U.n_rows);
...
inline
void
auxlib::lu(basic_mat<eT>& L, basic_mat<eT>& U, basic_mat<eT>& P, const basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
inline
void
auxlib::lu(basic_mat<eT>& L, basic_mat<eT>& U, const basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
//! immediate eigenvalues of a symmetric matrix using LAPACK
template<typename eT>
inline
void
auxlib::eig(basic_colvec<eT>& eigval, const basic_mat<eT>& A_orig)
  {
  arma_extra_debug_sigprint();
  ...
  // TODO: check for aliasing
    ...
    {
    const unwrap_check<basic_mat<eT> > tmp(A_orig, eigval);
    const basic_mat<eT>& A = tmp.M;
    
    arma_debug_check( (A.n_rows != A.n_cols), "auxlib::eig(): given matrix is not square");
  ...
  #else
    {
    arma_stop("auxlib::eig(): need LAPACK library");
    }
  #endif
  }
...
//! immediate eigenvalues and eigenvectors of a symmetric matrix using LAPACK
template<typename eT>
inline
void
auxlib::eig(basic_colvec<eT>& eigval, basic_mat<eT>& eigvec, const basic_mat<eT>& A_orig)
  {
  arma_extra_debug_sigprint();
  ...
  #if defined(ARMA_USE_LAPACK)
    {
    const unwrap_check< basic_mat<eT> > tmp1(A_orig, eigval);
    const basic_mat<eT>& A_tmp = tmp1.M;
    
    const unwrap_check< basic_mat<eT> > tmp2(A_tmp, eigvec);
    const basic_mat<eT>& A = tmp2.M;
...
inline
bool
auxlib::chol(basic_mat<eT>& out, const basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
inline
bool 
auxlib::qr(basic_mat<eT>& Q, basic_mat<eT>& R, const basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
inline
bool
auxlib::svd(basic_colvec<eT>& S, const basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
inline
bool
auxlib::svd(basic_colvec<T>& S, const basic_mat< std::complex<T> >& X)
  {
  arma_extra_debug_sigprint();
...
inline
bool
auxlib::svd(basic_mat<eT>& U, basic_colvec<eT>& S, basic_mat<eT>& V, const basic_mat<eT>& X)
  {
  arma_extra_debug_sigprint();
...
inline
bool
auxlib::svd(basic_mat< std::complex<T> >& U, basic_colvec<T> &S, basic_mat< std::complex<T> >& V, const basic_mat< std::complex<T> >& X)
  {
  arma_extra_debug_sigprint();
...
inline
bool
auxlib::solve(basic_mat<eT>& out, const basic_mat<eT>& A, const basic_mat<eT>& B)
  {
  arma_extra_debug_sigprint();
...
inline
bool
auxlib::solve_od(basic_mat<eT>& out, const basic_mat<eT>& A, const basic_mat<eT>& B)
  {
  arma_extra_debug_sigprint();
...
inline
bool
auxlib::solve_ud(basic_mat<eT>& out, const basic_mat<eT>& A, const basic_mat<eT>& B)
  {
  arma_extra_debug_sigprint();
