...
inline
void
op_stddev::apply(basic_mat<eT>& out, const basic_mat<eT>& X, const u32 norm_type, const u32 dim)
  {
...
inline
void
op_stddev::apply(basic_mat<T>& out, const basic_mat< std::complex<T> >& X, const u32 norm_type, const u32 dim)
  {
  arma_extra_debug_sigprint();
