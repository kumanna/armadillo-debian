...
trace(const arma_base<typename T1::elem_type,T1>& X)
  {
...
inline
typename T1::elem_type
trace(const glue_data<T1,T2,glue_plus>& X)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
trace(const glue_data<T1,T2,glue_minus>& X)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
trace(const glue_data<T1,T2,glue_schur>& X)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
trace(const op_data<T1,op_scalar_times>& in)
  {
  arma_extra_debug_sigprint();
...
inline
eT
trace(const op_data<basic_mat<eT>, op_diagmat>& X)
  {
  arma_extra_debug_sigprint();
...
inline
eT
trace(const op_data<basic_mat<eT>, op_diagmat_vec>& X)
  {
  arma_extra_debug_sigprint();
