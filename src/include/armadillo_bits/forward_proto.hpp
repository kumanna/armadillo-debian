...
template<typename T1, typename op_type> class op_data; 
template<typename T1, typename T2, typename glue_type> class glue_data;
...
enum file_type
  ...
  pgm_binary    //!< Portable Grey Map (image)
  };
