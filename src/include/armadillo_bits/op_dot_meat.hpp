...
op_dot::apply(const arma_base<typename T1::elem_type,T1>& A_orig, const arma_base<typename T1::elem_type,T2>& B_orig)
  {
  arma_extra_debug_sigprint();
...
inline
typename T1::elem_type
op_norm_dot::apply(const arma_base<typename T1::elem_type,T1>& A_orig, const arma_base<typename T1::elem_type,T2>& B_orig)
  {
  arma_extra_debug_sigprint();
