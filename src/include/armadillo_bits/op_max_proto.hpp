...
class op_max
  ...
  inline static void apply(basic_mat<typename T1::elem_type>& out, const op_data<T1,op_max>& in);
  ...
  inline static void apply(basic_mat< std::complex<T> >& out, const op_data<T1,op_max>& in);
