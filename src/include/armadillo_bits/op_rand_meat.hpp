...
inline
void
op_rand::apply(basic_mat<eT>& out, const op_data<basic_mat<eT>,op_rand>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_rand::apply(basic_mat<eT>& out, const op_data<basic_colvec<eT>,op_rand>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_rand::apply(basic_mat<eT>& out, const op_data<basic_rowvec<eT>,op_rand>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_rand::apply(basic_colvec<eT>& out, const op_data<basic_colvec<eT>,op_rand>& in)
  {
  arma_extra_debug_sigprint();
...
inline
void
op_rand::apply(basic_rowvec<eT>& out, const op_data<basic_rowvec<eT>,op_rand>& in)
  {
  arma_extra_debug_sigprint();
