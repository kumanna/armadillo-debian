...
namespace lapack
  ...
  extern "C"
    ...
    void  csyev_(char* jobz, char* uplo, int* n,   void* a, int* lda,   void* w,   void* work, int* lwork, int* info);    
    void  zsyev_(char* jobz, char* uplo, int* n,   void* a, int* lda,   void* w,   void* work, int* lwork, int* info);    
...
// SUBROUTINE DGELS( TRANS,  M, N, NRHS, A, LDA, B, LDB, WORK, LWORK, INFO)
  ...
  syev_(char* jobz, char* uplo, int* n, eT* a, int* lda, eT* w,  eT* work, int* lwork, int* info)
    ...
    if(is_supported_complex_float<eT>::value == true)
      {
      typedef std::complex<float> T;
      csyev_(jobz, uplo, n, (T*)a, lda, (T*)w, (T*)work, lwork, info);
      }
    else
    if(is_supported_complex_double<eT>::value == true)
      {
      typedef std::complex<double> T;
      zsyev_(jobz, uplo, n, (T*)a, lda, (T*)w, (T*)work, lwork, info);
      }
    }
