...
inline
void
glue_cube_schur::apply(Cube<typename T1::elem_type>& out, const GlueCube<T1,T2,glue_cube_schur>& X)
  {
  arma_extra_debug_sigprint();

  typedef typename T1::elem_type eT;

  const u32 N_cube = 1 + depth_lhs_cube< glue_cube_schur, GlueCube<T1,T2,glue_cube_schur> >::num;
  ...
  if(N_cube == 2)
    ...
    glue_cube_schur::apply(out, tmp1.M, tmp2.M);
    }
  else
    {
    ...
    cube_ptrs<glue_cube_schur, GlueCube<T1,T2,glue_cube_schur> >::get_ptrs(ptrs, del, X);
    ...
    for(u32 i=1; i<N_cube; ++i)
      {
      arma_debug_assert_same_size(tmp_cube, *(ptrs[i]), "cube schur product");
      }
...
inline
void
glue_cube_schur::apply_inplace(Cube<typename T1::elem_type>& out, const T1& X)
  {
  arma_extra_debug_sigprint();
  ...
  arma_debug_assert_same_size(out, B, "cube schur product");
...
inline
void
glue_cube_schur::apply_mixed(Cube<typename promote_type<eT1,eT2>::result>& out, const Cube<eT1>& X, const Cube<eT2>& Y)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_cube_schur::apply(Cube<eT>& out, const Cube<eT>& A, const Cube<eT>& B, const Cube<eT>& C)
  {
  arma_extra_debug_sigprint();
...
inline
void
glue_cube_schur::apply(Cube<eT>& out, const GlueCube<Cube<eT>,Cube<eT>,glue_cube_schur>& X)
  {
...
inline
void
glue_cube_schur::apply(Cube<eT>& out, const GlueCube< GlueCube<Cube<eT>,Cube<eT>,glue_cube_schur>, Cube<eT>,glue_cube_schur>& X)
  {
...
inline
void
glue_cube_schur::apply_inplace(Cube<typename T1::elem_type>& out, const GlueCube<T1, T2, glue_cube_schur>& X)
  {
  arma_extra_debug_sigprint();
